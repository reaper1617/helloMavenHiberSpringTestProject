                            ...
                            <div class="slider-info">
                                ...
                                <div class="col-md-4">
                                    <div class="banner-form-agileinfo" align="center">
                                        <h5> <span>Edit user (driver)</span></h5>

                                        <form action="/adminadduserdriver" id="addnewdriver" method="post">
                                            <input type="text" name="userName" form="addnewdriver" placeholder="Name"  >
                                            <input type="text" name="middleName" form="addnewdriver" placeholder="Middle name"  >
                                            <input type="text" name="lastName" form="addnewdriver" placeholder="Last name"  >
                                            <input type="password" class="ramka" name="password" form="addnewdriver" placeholder="Password" >
                                            <input type="text"  name="hoursWorked" form="addnewdriver" placeholder="Hours worked"  >
