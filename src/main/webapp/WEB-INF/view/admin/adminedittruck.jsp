                            ...
                            <div class="slider-info">
                                ...
                                <div class="col-md-4">
                                    <div class="banner-form-agileinfo" align="center">
                                        <h5> <span>Edit truck</span></h5>
                                        <form action="/adminedittruck" id="adminedittruck" method="post">
                                            <input type="text" name="registrationNumber" form="adminedittruck" placeholder="Registration number" >
                                            <input type="text" name="shift" form="adminedittruck" placeholder="Shift size"  >
                                            <input type="text" name="capacity" form="adminedittruck" placeholder="Capacity"  >
                                            <select class="ramka" name="currentCity" id="truckcity" form="adminedittruck">
                                                <c:forEach items="${citiesList}" var="cell">
                                                    <option value="${cell.id}">${cell.cityName}</option>
                                                </c:forEach>
                                            </select>
                                            <select class="ramka" name="state" id="truckstate" form="adminedittruck">
                                                <option id="READY">Ready</option>
                                                <option id="NOT_READY" selected>Not ready</option>
                                            </select>
                                            <input type="submit" formmethod="post" class="hvr-shutter-in-vertical" value="Edit truck!">
                                        </form>
                                    </div>
                                </div>
                            </div>
