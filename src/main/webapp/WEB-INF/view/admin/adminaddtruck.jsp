                            ...
                            <div class="slider-info">
                                ...
                                <div class="col-md-4">
                                    <div class="banner-form-agileinfo" align="center">
                                        ...
                                        <form action="/adminaddtruck" id="adminaddnewtruck" method="post">
                                            <input type="text" name="registrationNumber" form="adminaddnewtruck" placeholder="Registration number" required="required" >
                                            <input type="text" name="shift" form="adminaddnewtruck" placeholder="Shift size" required="required" >
                                            <input type="text" name="capacity" form="adminaddnewtruck" placeholder="Capacity" required="required" >
                                            <%--<input type="<select name="state" id="tss1"></select>--%>
                                            <select class="ramka" name="currentCity" id="truckcity" form="adminaddnewtruck">
                                                <c:forEach items="${citiesList}" var="cell">
                                                    <option value="${cell.id}">${cell.cityName}</option>
                                                </c:forEach>
                                            </select>

                                            <select class="ramka" name="state" id="truckstate" form="adminaddnewtruck">
